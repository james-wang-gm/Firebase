...
class CustomPipelineOptions(PipelineOptions):
    ...
    def _add_argparse_args(cls, parser):
        parser.add_value_provider_argument(
            ...
            default = '{}-analytics-data-lake/Firebase/Forum_Post_Created/ForumPostCreated_testing.json'.format(env))
        parser.add_value_provider_argument(
            '--output',
            type=str,
...
def streaming_pipeline(project, region="us-central1"):
    ...
    subscription = "projects/{}/subscriptions/Forum_Post_Created".format(project)
    bucket = "gs://{}-analytics-data-lake/Firebase/Forum_Post_Created/".format(env)
    ...
    options = PipelineOptions(
        ...
        template_location = "gs://{}-analytics-temp-files/Firebase/FB_ForumPostCreated_PStoGCS.py".format(env),
    ...
    class WriteToGCS(beam.DoFn):
        def __init__(self):
            self.outdir = "gs://{}-analytics-data-lake/Firebase/Forum_Post_Created/".format(env)
        ...
        def process(self, element):
            ...
            file_prefix = "Forum_Post_Created_Output_" + timestampStr + '.json' 
